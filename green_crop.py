        ...
        if (images.endswith(".jpg") or images.endswith(".png") or images.endswith(".jpeg")):
            ...
            for i in range(2, h-1):
                for j in range(2, w-1):
                    ...
                    if red > red_high and green < red*0.5 and blue < red*0.5:
                        red_high = red
                    if green > green_high and red < green*0.85 and blue < green*1.15:
                        green_high = green
                    if blue > blue_high:
                        blue_high = blue
            ...
            for i in range(w):
                for j in range(h):
                    ...
                    if green > 150*scale_factor and red < green*0.85 and blue < green*1.15:
                        if i < left_x:
                            left_x = i
                        if i > right_x:
                            right_x = i
            ...
            os.chdir(filename[z] + r'\green_detection')
