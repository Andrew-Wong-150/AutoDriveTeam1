        ...
        if (images.endswith(".jpg") or images.endswith(".png") or images.endswith(".jpeg")):
            ...
            for i in range(w):
                for j in range(h):
                    ...
                    if red > 180*scale_factor and green < red*0.65 and blue < red*0.85:
                        if i < left_x:
                            left_x = i
                        if i > right_x:
                            right_x = i
            ...
            os.chdir(filename[z] + r'\red_to_green')

            img.save(images)
            im = cv.imread(images)
            img = cv.GaussianBlur(im,(7,7),0)
            ...
            try:
                ...
                rand_green = random.randrange(800,1000,1)
                rand_green = rand_green/1000
                rand_red = random.randrange(250,450,1)
                rand_red = rand_red/1000
                rand_blue = random.randrange(600,rand_green*1000,1)
                ...
                try:
                    for i in range(w):
                        for j in range(h):
                            ...
                            if red > 130*scale_factor and green < red*0.65 and blue < red*0.85:
                                img.putpixel((x+i,y+j), (int(red*rand_red),int(red*rand_green),int(red*rand_blue)))
