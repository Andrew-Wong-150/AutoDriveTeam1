...
root = r'C:\Users\Andrew\Documents\AutoDrive\Color and Bulb Training\New'
...
def evaluate(model, loader, num_classes):
    ...
    print("accuracy_by_class\n", [i / j if j != 0 else None for i, j in zip(correct, count)])
...
def run():
    ...
    NUM_EPOCHS = 16
    BEST_MODEL_PATH = 'color_classifier_with_generated.pth'
    best_accuracy = 0.0
    
    writer = SummaryWriter('runs/color_classifier_with_generated')
    ...
    for epoch in range(NUM_EPOCHS):
        ...
        writer.add_scalars('val/acc', {'avg': val_acc,
                                      ...
                                      classes[2]: val_class_acc[2],
                                      classes[3]: val_class_acc[3]}, epoch)
        writer.add_scalars('train/acc', {'avg': train_acc,
                                      classes[0]: train_class_acc[0],
                                      classes[1]: train_class_acc[1],
                                      classes[2]: train_class_acc[2],
                                      classes[3]: train_class_acc[3]}, epoch)
