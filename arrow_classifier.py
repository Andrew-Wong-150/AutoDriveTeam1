...
root = r'C:\Users\Andrew\Documents\AutoDrive\Transfer Learning\Arrow_Classifier'
...
def run():
    ...
    NUM_EPOCHS = 16
    BEST_MODEL_PATH = 'arrow_classifier.pth'
    best_accuracy = 0.0
    
    writer = SummaryWriter('runs/arrow_classifier')
