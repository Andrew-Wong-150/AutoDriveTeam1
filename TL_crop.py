...
IMAGE_DIR_Mcity = "../0_Datasets/Mcity_image_jpg/"
...
for image_file in glob(IMAGE_DIR_Mcity + "*"):
    ...
    for i in range(len(boxes)):
        cropped_image = crop_roi_image(image_np, boxes[i])
        print(name + "_" + str(i) + ".jpg")
        plt.imsave(name + "_" + str(i) + ".jpg", cropped_image)
